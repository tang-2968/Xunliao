...
<div class="buju">
    <!-- 最左侧功能图标 -->
    <div class="buju_left fl" style="height: 1274px;">
    ...
    <!-- 最左侧功能图标 -->
    <!-- 中间功能列表-->
    <div class="buju_center fl" style="height: 1274px;">
        ...
        <div class="bcen_scroll" style="position: absolute; right: 0px; top: 62px; display: none; height: 212px;"></div>
        <div class="clear"></div>
        <div class="bcen_box" style="height: 1212px;">
            <div class="bcen_jilu">
    ...
    <!-- 中间功能列表-->
    <!-- 右边好友详情 -->
    <div class="buju_right fl" style="height: 1274px; width: 670px;">
        <div class="bri_top">
        ...
        <div class="bri_detail" style="display:none;">
            ...
            <a href="main.jsp"><div class="bri_detail_but">发消息</div></a>
        </div>
        <script>
            $(function (){
    ...
    <!-- 添加弹框 -->
    <div class="yinyings" style="display: none; height: 1274px;"></div>
