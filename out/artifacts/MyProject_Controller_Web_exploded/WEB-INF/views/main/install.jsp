...
<div class="buju">
    <div class="buju_left fl" style="height: 607px;">
        ...
        <div class="bleft_iconone fl">
            <a href="/main"><img src="common/img/chat010.png" width="100%"></a>
        </div>
    ...
    <div class="buju_right fl" style="height: 607px; width: 1056px;">
        ...
        <div class="bir_block">
            ...
            <div class="bir_block_font">小圣贤庄张三</div>
            <div class="bir_block_font">zhangliang_117</div>
            <a href=""><div class="bir_block_exit">退出登录</div></a>
        </div>
        <script>
            $(function (){
