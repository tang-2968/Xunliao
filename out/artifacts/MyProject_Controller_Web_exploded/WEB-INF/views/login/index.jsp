    ...
    <div class="main">
        <div class="mainLeft">
            ...
            <form method="post" action="/login/login">
                <input class="text" name="login" type="text" placeholder="支持QQ号/邮箱/手机号登录" required value="">
                <input type="password" name="password" placeholder=${a}>
<%--                <a class="a" href="main.jsp">授权并登录</a>--%>
                <input type="submit" value="授权并登录">
            </form>
            <form action="/login/index2">
